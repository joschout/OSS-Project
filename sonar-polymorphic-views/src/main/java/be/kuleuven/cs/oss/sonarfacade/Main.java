...
public class Main {
	...
	private static String queryString = "ck=polymorphic&resources=classes&parent=java:chess&type=scatter&shape=circle&circlediam=lines&xmetric=comment_lines&ymetric=lines";
